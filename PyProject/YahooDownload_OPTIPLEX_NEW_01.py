...
def getData(ticker):
    #print(ticker)cd
    try:
        data = pdr.get_data_yahoo(ticker, start=today-timedelta(5), end=today) #18000 in range
        #===============================================
        #commented below for testing
