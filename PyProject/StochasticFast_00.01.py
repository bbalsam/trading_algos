...
ticker_list=['DVA','EVRG','FFIV','FLIR','FTNT','GILD','NEM','ORCL','OXY','RMD','AMT','ANET','CMS','IFF','IPGP','LLY','MYL','AEP','SYK','AIG','CDW','EIX','FFIV','HII','NTAP','PNW','AAPL','AMZN','GLD','NFLX','SLV','SPY','TSLA']
